...
import { createGuard } from '@/lib/actions/guards';
...
export function CreateGuardDialog() {
  ...
  const [state, action, isPending] = useActionState<State, FormData>(createGuard, null);
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="rounded-2xl border-border/50 bg-card sm:max-w-md">
        <DialogHeader>
          <DialogTitle className="text-lg font-bold tracking-tight">Nuevo Guardia</DialogTitle>
        </DialogHeader>
